...
export class MCPWebUI {
    ...
    async createSession(userId) {
        try {
            ...
            const uiServer = new VanillaUIServer(session, this.config.schema, this.config.dataSource, this.config.onUpdate, this.config.pollInterval, this.config.bindAddress);
